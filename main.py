...
def attack(char_name: str, char_class: str) -> str:
    """Show how the character attacks."""
...
def defence(char_name: str, char_class: str) -> str:
    """Show how the character block attack."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Show if the character used special ability."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Show what kind of character you are."""
    if char_class == 'warrior':
    ...
    print('Введи одну из команд: attack — атаковать противника, '
          'defence — блокировать атаку или '
          'special — использовать свою суперсилу.')
...
def choice_char_class() -> str:
    """Start a game and let you choose a character to play."""
    approve_choice: str = ''
    char_class: str = ''
